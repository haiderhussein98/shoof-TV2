...
import 'package:shoof_tv/presentation/screens/vod/widgets/movie_center_controls.dart';
import 'package:shoof_tv/presentation/screens/vod/widgets/movie_loading_overlay.dart';
import 'package:shoof_tv/presentation/screens/vod/widgets/movie_seekbar.dart';
import 'package:shoof_tv/presentation/screens/vod/widgets/movie_top_controls.dart';
import 'package:shoof_tv/presentation/screens/vod/widgets/movie_video_view.dart';

class MoviePlayerMobile extends StatefulWidget {
  final String url;
  final String title;

  const MoviePlayerMobile({super.key, required this.url, required this.title});

  @override
  State<MoviePlayerMobile> createState() => _MoviePlayerMobileState();
}

class _MoviePlayerMobileState extends State<MoviePlayerMobile> {
